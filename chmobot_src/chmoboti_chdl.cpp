...
EXPORTCH int LinkbotI_driveAccelTimeNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
...
EXPORTCH int LinkbotI_accelJointCycloidalNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
	int id;
...
EXPORTCH int LinkbotI_driveAccelCycloidalNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double radius;
...
EXPORTCH int LinkbotI_accelJointHarmonicNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
	int id;
...
EXPORTCH int LinkbotI_driveAccelHarmonicNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double radius;
...
EXPORTCH int LinkbotI_driveAccelToVelocityNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double radius;
...
EXPORTCH int LinkbotI_driveAccelToMaxSpeedNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double radius;
...
EXPORTCH int LinkbotI_driveAccelDistanceNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double radius;
...
EXPORTCH int LinkbotI_accelJointTimeNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    int id;
...
EXPORTCH int LinkbotI_accelJointToVelocityNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    int id;
...
EXPORTCH int LinkbotI_accelJointToMaxSpeedNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    int id;
...
EXPORTCH int LinkbotI_accelJointAngleNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    int id;
...
EXPORTCH int LinkbotI_accelJointSmoothNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    int id;
...
EXPORTCH int LinkbotI_driveAccelSmoothNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double radius;
...
EXPORTCH int LinkbotI_getJointAngle_chdl(void *varg) {
    ...
    if(Ch_VaCount(interp, ap) == 1) {
      ...
      retval = mobot->getJointAngle((robotJointId_t)id, *angle, numReadings);
    } else {
...
EXPORTCH int LinkbotI_getJointAngleInstant_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    int id;
    ...
    id = Ch_VaArg(interp, ap, int);
    angle = Ch_VaArg(interp, ap, double *);
    retval = mobot->getJointAngleInstant((robotJointId_t)id, *angle);
    Ch_VaEnd(interp, ap);
    return retval;
}
...
EXPORTCH int LinkbotI_getJointAngles_chdl(void *varg) {
    ...
    if(Ch_VaCount(interp ,ap) == 1) {
      numReadings = Ch_VaArg(interp, ap, int);
      retval = mobot->getJointAngles(*angle1, *angle2, *angle3, numReadings);
    } else {
...
EXPORTCH int LinkbotI_getJointAnglesInstant_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double* angle1;
    ...
    angle2 = Ch_VaArg(interp, ap, double *);
    angle3 = Ch_VaArg(interp, ap, double *);
    retval = mobot->getJointAnglesInstant(*angle1, *angle2, *angle3);
    Ch_VaEnd(interp, ap);
    return retval;
}
...
EXPORTCH int LinkbotI_jumpTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double angle1;
    ...
    angle2 = Ch_VaArg(interp, ap, double);
    angle3 = Ch_VaArg(interp, ap, double);
    retval = mobot->jumpTo(angle1, angle2, angle3);
    Ch_VaEnd(interp, ap);
    return retval;
}
EXPORTCH int LinkbotI_jumpJointTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    robotJointId_t id;
    ...
    id = Ch_VaArg(interp, ap, robotJointId_t);
    angle = Ch_VaArg(interp, ap, double);
    retval = mobot->jumpJointTo(id, angle);
    Ch_VaEnd(interp, ap);
    return retval;
}
EXPORTCH int LinkbotI_jumpJointToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    robotJointId_t id;
    ...
    id = Ch_VaArg(interp, ap, robotJointId_t);
    angle = Ch_VaArg(interp, ap, double);
    retval = mobot->jumpJointToNB(id, angle);
    Ch_VaEnd(interp, ap);
    return retval;
}
...
EXPORTCH int LinkbotI_jumpToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double angle1;
    ...
    angle2 = Ch_VaArg(interp, ap, double);
    angle3 = Ch_VaArg(interp, ap, double);
    retval = mobot->jumpToNB(angle1, angle2, angle3);
    Ch_VaEnd(interp, ap);
    return retval;
}
...
EXPORTCH int LinkbotI_setJointPower_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    robotJointId_t id;
...
EXPORTCH int CMGI_jumpTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double angle1;
...
EXPORTCH int CMGI_jumpToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double angle1;
...
EXPORTCH int CMGI_jumpJointTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    robotJointId_t id;
...
EXPORTCH int CMGI_jumpJointToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    robotJointId_t id;
...
EXPORTCH int CMGI_moveForeverNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    int retval;
...
EXPORTCH int CMGI_moveJointForeverNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	robotJointId_t id;
...
EXPORTCH int CMGI_moveJoint_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	robotJointId_t id;
...
EXPORTCH int CMGI_moveJointNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	robotJointId_t id;
...
EXPORTCH int CMGI_moveTime_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	double time;
...
EXPORTCH int CMGI_moveTimeNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	double time;
...
EXPORTCH int CMGI_moveJointTime_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	robotJointId_t id;
...
EXPORTCH int CMGI_moveJointTimeNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	robotJointId_t id;
...
EXPORTCH int CMGI_setSpeed_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double speed;
...
EXPORTCH int CMGI_driveTimeNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	double time;
    ...
    mobot = Ch_VaArg(interp, ap, class CLinkbotIGroup *);
	time = Ch_VaArg(interp, ap, double);
    retval = mobot->driveTimeNB(time);
    Ch_VaEnd(interp, ap);
    return retval;
}
EXPORTCH int CMGI_driveTime_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
	double time;
    ...
    mobot = Ch_VaArg(interp, ap, class CLinkbotIGroup *);
	time = Ch_VaArg(interp, ap, double);
    retval = mobot->driveTime(time);
    Ch_VaEnd(interp, ap);
    return retval;
}
EXPORTCH int CMGI_driveDistance_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double distance;
    ...
    distance = Ch_VaArg(interp, ap, double);
    radius = Ch_VaArg(interp, ap, double);
    retval = mobot->driveDistance(distance, radius);
    Ch_VaEnd(interp, ap);
    return retval;
}

EXPORTCH int CMGI_driveDistanceNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double distance;
    ...
    distance = Ch_VaArg(interp, ap, double);
    radius = Ch_VaArg(interp, ap, double);
    retval = mobot->driveDistanceNB(distance, radius);
    Ch_VaEnd(interp, ap);
    return retval;
}
EXPORTCH int CMGI_driveForward_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double angle;
    ...
    mobot = Ch_VaArg(interp, ap, class CLinkbotIGroup *);
    angle = Ch_VaArg(interp, ap, double);
    retval = mobot->driveForward(angle);
    Ch_VaEnd(interp, ap);
    return retval;
}

EXPORTCH int CMGI_driveForwardNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double angle;
    ...
    mobot = Ch_VaArg(interp, ap, class CLinkbotIGroup *);
    angle = Ch_VaArg(interp, ap, double);
    retval = mobot->driveForwardNB(angle);
    Ch_VaEnd(interp, ap);
    return retval;
}
EXPORTCH int CMGI_driveBackward_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double angle;
    ...
    mobot = Ch_VaArg(interp, ap, class CLinkbotIGroup *);
    angle = Ch_VaArg(interp, ap, double);
    retval = mobot->driveBackward(angle);
    Ch_VaEnd(interp, ap);
    return retval;
}

EXPORTCH int CMGI_driveBackwardNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    double angle;
    ...
    mobot = Ch_VaArg(interp, ap, class CLinkbotIGroup *);
    angle = Ch_VaArg(interp, ap, double);
    retval = mobot->driveBackwardNB(angle);
    Ch_VaEnd(interp, ap);
    return retval;
}
EXPORTCH int CMGI_driveForeverNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotIGroup *mobot;
    int retval;
...
EXPORTCH int LinkbotI_moveForeverNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    int retval;
...
EXPORTCH int LinkbotI_moveJointForeverNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
	robotJointId_t id;
...
EXPORTCH int LinkbotI_driveDistance_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double distance;
...
EXPORTCH int LinkbotI_driveDistanceNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double distance;
...
EXPORTCH int LinkbotI_driveForward_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double angle;
...
EXPORTCH int LinkbotI_driveForwardNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double angle;
...
EXPORTCH int LinkbotI_driveBackward_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double angle;
...
EXPORTCH int LinkbotI_driveBackwardNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double angle;
...
EXPORTCH int LinkbotI_driveTime_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double time;
...
EXPORTCH int LinkbotI_driveTimeNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double time;
...
EXPORTCH int LinkbotI_driveForeverNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    int retval;
...
EXPORTCH int LinkbotI_drivexy_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double x, y, radius, trackwidth;
    ...
    radius = Ch_VaArg(interp, ap, double);
    trackwidth = Ch_VaArg(interp, ap, double);
    retval = mobot->drivexy(x, y, radius, trackwidth);
    Ch_VaEnd(interp, ap);
    return retval;
}

EXPORTCH int LinkbotI_drivexyNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double x, y, radius, trackwidth;
    ...
    radius = Ch_VaArg(interp, ap, double);
    trackwidth = Ch_VaArg(interp, ap, double);
    retval = mobot->drivexyNB(x, y, radius, trackwidth);
    Ch_VaEnd(interp, ap);
    return retval;
}
EXPORTCH int LinkbotI_drivexyTo_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double x, y, radius, trackwidth;
    ...
    radius = Ch_VaArg(interp, ap, double);
    trackwidth = Ch_VaArg(interp, ap, double);
    retval = mobot->drivexyTo(x, y, radius, trackwidth);
    Ch_VaEnd(interp, ap);
    return retval;
}

EXPORTCH int LinkbotI_drivexyToExpr_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double x0, xf;
	...
	radius = Ch_VaArg(interp, ap, double);
	trackwidth = Ch_VaArg(interp, ap, double);
    retval = mobot->drivexyToExpr(x0, xf, n, expr, radius, trackwidth);
    Ch_VaEnd(interp, ap);
    return retval;
}
typedef double (*IdrivexyToFuncHandle)(double);
//static ChInterp_t interpI;
static double IdrivexyToFunc_chdl_funarg(double x);
static void *IdrivexyToFunc_chdl_funptr;
EXPORTCH int LinkbotI_drivexyToFunc_chdl(void *varg) {
    ChVaList_t ap;
    class CLinkbotI *robot;
    double x0;
    double xf;
    int n;
    IdrivexyToFuncHandle handle_ch, handle_c = NULL;
    double radius;
    double trackwidth;
    int retval;
    ...
    xf = Ch_VaArg(interpI, ap, double);
    n = Ch_VaArg(interpI, ap, int);
    handle_ch = Ch_VaArg(interpI, ap, IdrivexyToFuncHandle);
    IdrivexyToFunc_chdl_funptr = (void *)handle_ch;
    if (handle_ch != NULL) {
        handle_c = (IdrivexyToFuncHandle)IdrivexyToFunc_chdl_funarg;
    }    
    radius = Ch_VaArg(interpI, ap, double);
    trackwidth = Ch_VaArg(interpI, ap, double);
...
static double IdrivexyToFunc_chdl_funarg(double x) { 
    double retval;
    Ch_CallFuncByAddr(interpI, IdrivexyToFunc_chdl_funptr, &retval, x);
    return retval;
}

EXPORTCH int LinkbotI_drivexyToNB_chdl(void *varg) {
    ChInterp_t interp;
    ChVaList_t ap;
    class CLinkbotI *mobot;
    double x, y, radius, trackwidth;
    ...
    radius = Ch_VaArg(interp, ap, double);
    trackwidth = Ch_VaArg(interp, ap, double);
    retval = mobot->drivexyToNB(x, y, radius, trackwidth);
    Ch_VaEnd(interp, ap);
    return retval;
}
