...
\texttt{moveBackward()} & Makes all mobots in the group roll backward. \\
\texttt{moveForwardNB()} & Makes all mobots in the group roll forward. \\
...
\texttt{turnLeft()} & Make all mobots in the group turn left. \\
\texttt{turnLeftNB()} & Make all mobots in the group turn left. \\
\texttt{turnRight()} & Make all mobots in the group turn right. \\
\texttt{turnRightNB()} & Make all mobots in the group turn right.\\
