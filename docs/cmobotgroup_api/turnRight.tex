...
\rule{4.5in}{0.015in}\\
\noindent
{\LARGE \texttt{CMobotGroup::turnRight()}\index{CMobotGroup::turnRight()}}\\
{\LARGE \texttt{CMobotGroup::turnRightNB()}\index{CMobotGroup::turnRightNB()}}\\
%\phantomsection
\addcontentsline{toc}{section}{turnRight()}
\addcontentsline{toc}{section}{turnRightNB()}
