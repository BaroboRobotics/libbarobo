...
\input{cmobotgroup_api/driveJointTo}
\input{cmobotgroup_api/driveTo}
\input{cmobotgroup_api/motionArch}
\input{cmobotgroup_api/moveDistance}
...
\input{cmobotgroup_api/moveBackward}
\input{cmobotgroup_api/moveForward}
...
\input{cmobotgroup_api/resetToZero}
%\input{cmobotgroup_api/setJointDirection}
\input{cmobotgroup_api/setExitState}
\input{cmobotgroup_api/setJointMovementStateNB}
\input{cmobotgroup_api/setJointMovementStateTime}
\input{cmobotgroup_api/setJointSafetyAngle}
\input{cmobotgroup_api/setJointSafetyAngleTimeout}
...
\input{cmobotgroup_api/setMovementStateNB}
\input{cmobotgroup_api/setMovementStateTime}
\input{cmobotgroup_api/setTwoWheelRobotSpeed}
\input{cmobotgroup_api/stop}
\input{cmobotgroup_api/turnLeft}
\input{cmobotgroup_api/turnRight}
