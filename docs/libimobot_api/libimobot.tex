...
\newpage
\input{libimobot_api/getMotorDirection}
\pagebreak
\input{libimobot_api/getMotorPosition}
\pagebreak
\input{libimobot_api/getMotorSpeed}
\pagebreak
\input{libimobot_api/getMotorState}
\pagebreak
\input{libimobot_api/initListenerBluetooth}
\pagebreak
\input{libimobot_api/isBusy}
\pagebreak
\input{libimobot_api/listenerMainLoop}
\pagebreak
\input{libimobot_api/moveWait}
\pagebreak
\input{libimobot_api/poseZero}
\pagebreak
\input{libimobot_api/setMotorDirection}
\pagebreak
\input{libimobot_api/setMotorPosition}
\pagebreak
\input{libimobot_api/setMotorSpeed}
\pagebreak
\input{libimobot_api/stop}
\pagebreak
\input{libimobot_api/terminate}
\pagebreak
\input{libimobot_api/waitMotor}
