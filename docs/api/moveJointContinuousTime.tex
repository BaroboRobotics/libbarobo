...
\rule{4.5in}{0.015in}\\
\noindent
{\LARGE \texttt{CMobot::moveJointContinuousTime()}\index{CMobot::moveJointContinuousTime()}}\\
%\phantomsection
...
\begin{verbatim}
#include <mobot.h>
int CMobot::moveJointContinuousTime(mobotJointId_t id, mobotJointState_t dir1, double seconds);
\end{verbatim}
