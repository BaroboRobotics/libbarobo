...
\texttt{turnLeft()} & Rotate the mobot counterclockwise. \\
\texttt{turnLeftNB()} & Identical to \texttt{turnLeft()} but non-blocking. \\
\texttt{turnRight()} & Rotate the mobot clockwise. \\
...
\texttt{moveDistance()} \dotfill & Roll a wheeled Mobot a certain distance. \\
\texttt{moveDistanceNB()} \dotfill & Identical to \texttt{moveDistance} but non-blocking. \\
...
\input{api/move}
\input{api/moveBackward}
\input{api/moveForward}
\input{api/moveJoint}
