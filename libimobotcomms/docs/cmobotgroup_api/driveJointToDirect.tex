...
\rule{4.5in}{0.015in}\\
\noindent
{\LARGE \texttt{CMobotGroup::driveJointToDirect()}\index{CMobotGroup::driveJointToDirect()}}\\
{\LARGE \texttt{CMobotGroup::driveJointToDirectNB()}\index{CMobotGroup::driveJointToDirectNB()}}\\
%\phantomsection
