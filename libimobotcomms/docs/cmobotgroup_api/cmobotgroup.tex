...
\hline
\texttt{motionArch()} \dotfill & Move the robot into an arched configuration. \\
...
\texttt{motionSkinny()} \dotfill & Move the robot into a skinny configuration. \\
\texttt{motionSkinnyNB()} \dotfill & Identical to \texttt{motionSkinnyNB()} but non-blocking. \\
...
\texttt{motionTumble()} \dotfill & Tumble the robot end over end. \\
\texttt{motionTumbleNB()} \dotfill & Identical to \texttt{motionTumbleNB()} but non-blocking. \\
...
\texttt{motionUnstand()} \dotfill & Move a robot currently standing on its end down into a prone position. \\
\texttt{motionUnstandNB()} \dotfill & Identical to \texttt{motionUnstand()} but non-blocking. \\
\texttt{motionWait()} \dotfill & Wait for preprogrammed robotic motions to complete. \\
\hline
\end{tabular}
\end{center}
