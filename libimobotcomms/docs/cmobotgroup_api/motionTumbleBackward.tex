...
\rule{4.5in}{0.015in}\\
\noindent
{\LARGE \texttt{CMobotGroup::motionTumbleBackward()}\index{CMobotGroup::motionTumbleBackward()}}\\
{\LARGE \texttt{CMobotGroup::motionTumbleBackwardNB()}\index{CMobotGroup::motionTumbleBackwardNB()}}\\
%\phantomsection
