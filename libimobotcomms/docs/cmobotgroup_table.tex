...
\texttt{setTwoWheelMobotSpeed()} & Move the robots at a constant forward velocity. \\
...
\texttt{setTwoWheelMobotSpeed()} & Move the robot at a linear speed, given the wheel size and desired speed.\\
