...
\texttt{motionTumbleBackward()} & Make all the robots in the group perform the tumbling motion. \\
\texttt{motionTumbleBackwardNB()} & Make all the robots in the group perform the tumbling motion. \\
\texttt{motionTumbleForward()} & Make all the robots in the group perform the tumbling motion. \\
\texttt{motionTumbleForwardNB()} & Make all the robots in the group perform the tumbling motion. \\
