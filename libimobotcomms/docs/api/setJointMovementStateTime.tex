...
\rule{4.5in}{0.015in}\\
\noindent
{\LARGE \texttt{CMobot::setJointMovementStateTime()}\index{CMobot::setJointMovementStateTime()}}\\
{\LARGE \texttt{CMobot::setJointMovementStateTimeNB()}\index{CMobot::setJointMovementStateTimeNB()}}\\
%\phantomsection
