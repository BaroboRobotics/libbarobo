...
\texttt{speed1} & The speed for the first joint, in radians per second. \\
\texttt{speed2} & The speed for the second joint, in radians per second. \\
\texttt{speed3} & The speed for the third joint, in radians per second. \\
\texttt{speed4} & The speed for the fourth joint, in radians per second. \\
\end{tabular}
\end{description}
