...
\texttt{setJointSafetyAngle()} & Set the robot's safety angle limit. The default value is 10 degrees.\\
\texttt{setJointSafetyAngleTimeout()} & Set the robot's safety angle limit timeout. The default value is 0.5 seconds.\\
...
\input{api/setTwoWheelMobotSpeed}
\input{api/stop}
