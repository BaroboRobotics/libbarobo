...
\texttt{getJointSpeed()} & Gets a motor's current speed setting in radians per second. \\
\texttt{getJointSpeeds()} & Gets all motor's current speed settings in radians per second. \\
\texttt{getJointSpeedRatio()} & Gets a motor's speed as a ratio of the motor's maximum speed. \\
\texttt{getJointSpeedRatios()} & Gets all motor speeds as ratios of the motor's maximum speed. \\
