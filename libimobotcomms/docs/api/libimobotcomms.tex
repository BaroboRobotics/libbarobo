...
\texttt{moveToPID()} & Move all four joints of the mobot to specified absolute angles. \\
\texttt{moveToPIDNB()} & Move all four joints of the mobot to specified absolute angles. \\
...
\input{api/moveJointToAbs}
\input{api/moveJointToDirect}
\input{api/moveJointWait}
\input{api/moveTo}
\input{api/moveToAbs}
\input{api/moveToDirect}
\input{api/moveToPID}
