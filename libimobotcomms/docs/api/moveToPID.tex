...
\rule{4.5in}{0.015in}\\
\noindent
{\LARGE \texttt{CMobot::moveToPID()}\index{CMobot::moveToPID()}}\\
{\LARGE \texttt{CMobot::moveToPIDNB()}\index{CMobot::moveToPIDNB()}}\\
%\phantomsection
\addcontentsline{toc}{section}{moveToPID()}
\addcontentsline{toc}{section}{moveToPIDNB()}
