...
entire upgrade process can be cancelled by clicking on the ``Cancel'' button.
...
in \ref{fig:reset1}. To begin the process, type in the address of the Mobot to be reflashed
