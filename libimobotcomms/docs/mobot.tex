...
\item \texttt{motionTumbleBackward()}: This function causes the robot to perform the
tumbling motion, flipping end over end.
\item \texttt{motionTumbleForward()}: This function causes the robot to perform the
tumbling motion, flipping end over end.
...
\subsection{\texttt{tumble.ch}: A Demo Using the \texttt{motionTumbleForward()} Preprogrammed
Motion}
...
"motionTumbleForward()" and "motionUnstand()" will be discussed in Section \ref{sec:blocking}.
...
\item \texttt{motionTumbleBackward()}
\item \texttt{motionTumbleForward()}
...
\item \texttt{motionTumbleBackwardNB()}
\item \texttt{motionTumbleForwardNB()}
