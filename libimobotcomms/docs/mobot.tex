...
in the text box on the top of the dialog, as shown below.

\includegraphics[width=4.5in]{images/shot5.png}

Next, click the ``Add'' button. The newly added address should appear in the 
list of known addresses, as shown below. In our case, we have added the 
address of one of our robots, which is \texttt{"00:06:66:43:0E:02"}.

\includegraphics[width=4.5in]{images/shot6.png}

We use the same process to add our remaining two robots to the list,
with addresses \texttt{"00:06:66:43:0D:F2"} and 
\texttt{"00:06:66:47:23:9C"}. The dialog now appears as such:

\includegraphics[width=4.5in]{images/shot8.png}
...
the ``Move Up'' button is shown below.

\includegraphics[width=4.5in]{images/shot10.png}
...
\subsection{\texttt{robotJointId\_t}}
\index{robot\_joints\_t}
The data type \texttt{robotJointId\_t} contains the following macro datatypes.\\
...
\subsection{\texttt{robotJointDirection\_t}}
\index{robot\_joint\_direction\_t}
The data type \texttt{robotJointDirection\_t} indicates the commanded direction 
