...
First, add your Mobot-A address(es) into RoboMancer by typing in the address and
...
Upon connecting to Mobot-As, RoboMancer is able to determine if the firmware 
...
connect to the Mobot-A using RoboMancer and upgrade the firmware back to the most up-to-date
version.
...
The first time RoboMancer is started, it will try and search for a Mobot-I/L or a Mobot dongle
...
\end{center}
\caption{\label{fig:shot1_dof.png} The graphical display of RoboMancer
