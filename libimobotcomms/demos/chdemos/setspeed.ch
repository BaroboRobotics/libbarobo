...
double speed, radius;
mobot.getJointMaxSpeed(ROBOT_JOINT1, speed);
printf("The maximum speed is %lf degrees/s\n", speed);

mobot.setJointSpeed(ROBOT_JOINT1, 60);
mobot.setJointSpeed(ROBOT_JOINT4, 60);
...
mobot.setMovementStateTime(ROBOT_FORWARD, ROBOT_HOLD, ROBOT_HOLD, ROBOT_FORWARD, 3);
