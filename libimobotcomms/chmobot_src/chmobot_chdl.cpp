...
EXPORTCH int getJointAngleAbs_chdl(void *varg) {
    ...
    id = Ch_VaArg(interp, ap, int);
    angle = Ch_VaArg(interp, ap, double *);
    retval = mobot->getJointAngleAbs((mobotJointId_t)id, *angle);
    Ch_VaEnd(interp, ap);
    return retval;
}
...
EXPORTCH int getJointState_chdl(void *varg) {
    ...
    retval = mobot->getJointState((mobotJointId_t)id, (robotJointState_t&)(*state));
    Ch_VaEnd(interp, ap);
    return retval;
}
...
EXPORTCH int stopTwoJoints_chdl(void *varg) {
    ...
    Ch_VaStart(interp, ap, varg);
    mobot = Ch_VaArg(interp, ap, class CMobot *);
    id1 = Ch_VaArg(interp, ap, mobotJointId_t);
    id2 = Ch_VaArg(interp, ap, mobotJointId_t);
...
EXPORTCH int stopThreeJoints_chdl(void *varg) {
    ...
    id1 = Ch_VaArg(interp, ap, mobotJointId_t);
    id2 = Ch_VaArg(interp, ap, mobotJointId_t);
    id3 = Ch_VaArg(interp, ap, mobotJointId_t);
