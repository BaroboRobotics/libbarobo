...
DLLIMPORT int Mobot_motionTumbleBackward(br_comms_t* comms, int num);
DLLIMPORT int Mobot_motionTumbleForward(br_comms_t* comms, int num);
...
DLLIMPORT int Mobot_motionTumbleBackwardNB(br_comms_t* comms, int num);
DLLIMPORT int Mobot_motionTumbleForwardNB(br_comms_t* comms, int num);
